...
import imgadam from '../assets/img/perfiladam.png'
  ...
  return (
    <section className="contact-adam">
      <div className="container">
        ...
        <div className="card">
          <img src={imgadam} alt="Adam Jiménez" className="profile-pic" />
          <div className="info">
            <h3>Adam Agudelo</h3>
            <p className="profession">Desarrollador Full Stack</p>
            <p><FaEnvelope /> adammaster29@gmail.com</p>
            <p><FaWhatsapp /> +57 3013803583</p>
